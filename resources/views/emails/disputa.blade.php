...
<head>
    <meta charset="UTF-8">
    <title>Disputa de venta {{$sale->folio}}</title>
</head>
...
<div style="max-width: 600px; margin: auto; background-color: #dcdcdc; padding: 30px; border-radius: 8px;">
    ...
    <p style="font-size: 16px;">Es posible que la venta con folio <strong>{{$sale->folio}}</strong> se encuentre en disputa y se ha cancelado dentro del sistema.</p>
