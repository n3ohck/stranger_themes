...
Route::get('branches',[\App\Http\Controllers\Admin\SucursalCrudController::class,'fetch']);
Route::get('reports/payments',[\App\Http\Controllers\Admin\PaymentReportController::class,'fetch']);
